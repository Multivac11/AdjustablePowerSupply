...
StatusKey::StatusKey(
    gpio_num_t p1, gpio_num_t p2, gpio_num_t p3, gpio_num_t p4, gpio_num_t p5, gpio_num_t p6, uint32_t lm)
    : longMs_(lm), queue_(nullptr)
{
    key_pin_[0] = p1;
    key_pin_[1] = p2;
    key_pin_[2] = p3;
...
void StatusKey::InitKeys()
{
    ...
    gpio_config_t gpio_cfg = {
        .pin_bit_mask = (1ULL << key_pin_[0]) | (1ULL << key_pin_[1]) | (1ULL << key_pin_[2]) | (1ULL << key_pin_[3]) |
                        (1ULL << key_pin_[4]) | (1ULL << key_pin_[5]),
