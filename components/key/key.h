...
class StatusKey
{
   public:
    ...
    StatusKey(gpio_num_t key_pin1 = GPIO_NUM_1,
              gpio_num_t key_pin2 = GPIO_NUM_2,
              gpio_num_t key_pin3 = GPIO_NUM_3,
              gpio_num_t key_pin4 = GPIO_NUM_4,
              gpio_num_t key_pin5 = GPIO_NUM_5,
              gpio_num_t key_pin6 = GPIO_NUM_12,
